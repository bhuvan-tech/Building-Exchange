    ...
    if (side === 'buy') {
        orderbook_1.orderBook.asks.forEach((o) => {
            if (o.price <= price && quantity > 0) {
                ...
                orderbook_1.bookWithQuantity.asks[o.price] =
                    (orderbook_1.bookWithQuantity.asks[o.price] || 0) - filledQuantity;
                fills.push({
                    price: o.price,
                    qty: filledQuantity,
        ...
        if (quantity !== 0) {
            ...
            orderbook_1.bookWithQuantity.bids[price] =
                (orderbook_1.bookWithQuantity.bids[price] || 0) + (quantity - executedQty);
        }
    }
    else {
        orderbook_1.orderBook.bids.forEach((o) => {
            if (o.price >= price && quantity > 0) {
                ...
                o.quantity -= filledQuantity;
                orderbook_1.bookWithQuantity.bids[price] =
                    (orderbook_1.bookWithQuantity.bids[price] || 0) - filledQuantity;
                fills.push({
                    price: o.price,
                    qty: filledQuantity,
                    tradeId: GLOBAL_TRADE_ID++,
        ...
        if (quantity !== 0) {
            ...
            orderbook_1.bookWithQuantity.asks[price] =
                (orderbook_1.bookWithQuantity.asks[price] || 0) + quantity;
        }
    }
